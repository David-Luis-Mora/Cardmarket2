...
urlpatterns = [
    ...
    path(
        'users/all-cards-sold-by-user/', views.all_cards_sold_by_user, name='all-cards-sold-by-user'
    ),
    path(
        'users/all-card-purchased-for-user/',
    ...
    path('users/cart/delete/delete-cart-sold/', views.delete_cart_sold, name='delete-cart-sold'),
    ...
    path(
        'users/my-cards-for-sale/<int:pk>/', views.card_for_sale_detail, name='card_for_sale_detail'
    ),
